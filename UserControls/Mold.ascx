<%@ Register TagPrefix="uc2" TagName="ServiceList" Src="ServiceList.ascx" %>
<%@ Control Language="vb" AutoEventWireup="false" Codebehind="Mold.ascx.vb" Inherits="FES.Mold" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
				...
				<TABLE id="Table2" cellSpacing="0" cellPadding="0" width="100%" border="0">
					<TR>
						<TD style="WIDTH: 152px" align="middle" vAlign="top"><BR>
							<uc2:ServiceList id="ServiceList1" runat="server"></uc2:ServiceList>
						</TD>
						<TD vAlign="top"><BR>
							&nbsp;&nbsp;&nbsp;&nbsp;<BR>
							<BR>
