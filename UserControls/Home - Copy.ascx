				...
				<TABLE id="Table2" cellSpacing="0" cellPadding="0" width="100%" border="0">
					<TR>
						<TD style="WIDTH: 152px" align="middle" vAlign="top"><BR>
							<uc1:ServiceList id="ServiceList1" runat="server"></uc1:ServiceList><BR>
						</TD>
						<TD vAlign="top"><BR>
							&nbsp;&nbsp;&nbsp;&nbsp;<BR>
							<BR>
								...
								<TR>
									...
									<TD width="75%">
										<DIV style="FONT-SIZE: 12px; COLOR: #003333; FONT-FAMILY: 'MS Reference Sans Serif'">For 
											over a decade, the experts at Farmer Environmental Services, L.L.C. have helped 
											thousands of customers deal with environmental issues in a fast, safe, and 
											economical manner. Every project receives our full attention to detail. There 
											is no limit to what we will do to insure our customers are completely 
											satisfied.</DIV>
									</TD>
									<TD align="middle" width="20%"><IMG alt="FES Professional Analysis" src="Images/Burke.gif"></TD>
								</TR>
							</TABLE>
						</TD>
					</TR>
